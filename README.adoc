...
L’https://www.ent.dauphine.fr/annuaire/index.php?param0=fiche&param1=ocailloux[enseignant].
...
* Vous êtes censés consulter vos e-mails Dauphine (pour annonces via MyCourse)
* Vous êtes censés être présents
